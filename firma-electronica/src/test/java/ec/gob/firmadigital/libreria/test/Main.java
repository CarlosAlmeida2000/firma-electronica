...
public class Main {
    ...
    // ARCHIVO
    private static final String PKCS12 = "C:\\firmasjr\\SUAREZ.p12";
    //private static final String PASSWORD = "Erick1994";
    //private static final String PASSWORD = "Tano2020";
    private static final String PASSWORD = "DANY2809";
    //private static final String PASSWORD = "Servi-Lion2023";
...
//    private static final String FILE = "/home/mfernandez/Test/Verify/09.pdf";
    private static final String FILE = "C:\\firmasjr\\1\\2\\CONSUMO-CORRIENTE-164-signed.pdf";
...
//            PadesEnhancedSigner pdfSigner = new PadesEnhancedSigner(signer);
        ...
        String nombreDocumento = FileUtils.crearNombreFirmado(archivo, FileUtils.getExtension(signed));
...
//    }
    ...
    private static Properties parametros() throws IOException, HoraServidorException {
        ...
        LocalDateTime fechaHora = LocalDateTime.parse("2025-04-23T16:20:12.372698");
